	...
	<div class="container">
		<div class="row">
			...
			<form id="changeUserInfo" class="item_2 clearfix" enctype="multipart/form-data" method="post" action="">
				...
				<input type="hidden" name="id" value="<?php echo e($info_account->id); ?>">
				...
				<div class="filed clearfix">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="name" id="name" value="<?php echo e(old('name',isset($info_account->name) ? $info_account->name : null )); ?>" <?php if($errors->has('name')): ?> autofocus <?php endif; ?>>
					</div>
					<div class="col-sm-1">
				...
				<div class="filed clearfix">
					...
					<div class="col-sm-6">
					    <div class="avatar">
					    	<img id="image-loading" src="<?php echo e(asset('images/general/bx_loader.gif')); ?>" width="50" height="50">
					    	<input type="hidden" id="avatar" name="avatar" value="<?php echo e($info_account->avatar); ?>">
					    	<?php if(strlen($info_account->avatar) > 0): ?>
                            	<img src="<?php echo e(url('/')); ?>/uploads/users/<?php echo e($info_account->avatar); ?>" id="avatar-image" class="img" alt="Avatar">
                            <?php else: ?>
                            	<img src="<?php echo e(url('/')); ?>/frontend/images/avartar_default.png" id="avatar-image" class="img" alt="Avatar">
                            <?php endif; ?>
					    </div>
				...
				<div class="filed clearfix">
					...
					<div class="col-sm-6">
						<input type="radio" name="gender" value="1" <?php if(old('gender',isset($info_account->gender) ? $info_account->gender : null) == 1): ?> checked="checked" <?php endif; ?>> Male
						<input type="radio" name="gender" value="0" <?php if(old('gender',isset($info_account->gender) ? $info_account->gender : null) != null && old('gender',isset($info_account->gender) ? $info_account->gender : null) == 0): ?> checked="checked" <?php endif; ?>> Female
					</div>
				</div>
				<div class="filed clearfix">
					<div class="col-sm-3 text-right">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control"  id="datepicker" name="birthday"  pattern="\d{1,2}/\d{1,2}/\d{4}" value="<?php echo e(old('birthday',isset($info_account->birthday) ?  BatvHelper::formatDateStandard('Y-m-d',$info_account->birthday,'d/m/Y') : null )); ?>" <?php if($errors->has('birthday')): ?> autofocus <?php endif; ?>>
						<script>
						  $(function() {
				...
				<div class="filed clearfix">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="phone" placeholder="+XXX-XXX-XXXXX" value="<?php echo e(old('phone',isset($info_account->phone) ? $info_account->phone : null )); ?>" <?php if($errors->has('phone')): ?> autofocus <?php endif; ?>>
					</div>
					<div class="col-sm-1">
				...
				<div class="filed clearfix">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="address"  value="<?php echo e(old('address',isset($info_account->address) ? $info_account->address : null )); ?>" <?php if($errors->has('address')): ?> autofocus <?php endif; ?>>
					</div>	
					<div class="col-sm-1">
				...
				<div class="filed clearfix">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="career"  value="<?php echo e(old('career',isset($info_account->career) ? $info_account->career : null )); ?>" <?php if($errors->has('career')): ?> autofocus <?php endif; ?>>
					</div>
					<div class="col-sm-1">
				...
				<div class="filed clearfix">
					...
					<div class="col-sm-6">
						<input type="text" class="form-control" name="organization"  value="<?php echo e(old('organization',isset($info_account->organization) ? $info_account->organization : null )); ?>" <?php if($errors->has('organization')): ?> autofocus <?php endif; ?>>
					</div>
					<div class="col-sm-1">
	...
	$(document).ready(function(){
		...
		function getLocalStore(){
			...
			if(typeof $( "input[name='id']" ) != "undefined" && formData.id == $( "input[name='id']" ).val()){
				...
				$( "#avatar-image" ).attr("src", "<?php echo e(url('/')); ?>/uploads/users/" + formData.avatar);
			}
		}
		...
		$("#form").submit(function(e) {
		  ...
		  $.ajax({
		    url: "<?php echo e(url('/')); ?>/images/uploadImage",
		    type: "POST",
		    data: formData,
		    contentType: false,
		    processData: false,
		    ...
		    success: function(data) {
		    	if(data.code == 200){
		    		$('#avatar-image').attr('src', "<?php echo e(url('/')); ?>/uploads/users/" + data.image_url);
