		...
		<div class="row">
			<div class="col-sm-offset-3 col-sm-6">
				<div class="item clearfix">
					...
					<div class="search">
						<input type="text" name="barcode" id="barcodetxt" class="form-control"  placeholder="Enter a barcode number" value="<?php echo e(isset($barcode) ? $barcode : ''); ?>" required>
...
<script type="text/javascript">
	function validateKeywords() {
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo e(route('get-slug-barcode')); ?>",
            data: data,
            dataType: 'json',
            ...
            success: function(response) {
                if(response.status == 200) {
                	window.location.replace("<?php echo e(route('index')); ?>" + "/barcode/" + response.slug + "-" + keywords);
                } else {
                	window.location.replace("<?php echo e(route('index')); ?>" + "/barcode/s-" + keywords);
                }
            },
            error: function (data) {
