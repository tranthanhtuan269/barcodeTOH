        ...
        <div class="add-barcode account clearfix">
            ...
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    ...
                    <div id="collapse1" class="panel-collapse collapse <?php echo e($class_import); ?>">
                        <div class="panel-body">
                            <form enctype="multipart/form-data" method="post" id="form-upload-excel">
                                <div class="col-sm-4">
                                    <i style="font-weight: 600;">File example : </i> <a href="<?php echo e(asset('uploads/example.xlsx')); ?>" style="color: #00a651 !important;">Download</a>
                                </div>
                                <div class="col-sm-4">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapse2" class="panel-collapse collapse <?php echo e($class_normal); ?>">
                        <div class="panel-body">
                            <!-- Thông báo -->
                            <form action="<?php echo e(route('addBarCodeNormalByUserAjax')); ?>" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="item_detail">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                ...
                                                <input type="hidden" name="avg_price" id="result" value="<?php echo e(BatvHelper::parse_number(old('avg_price_tmp'))); ?>">
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="name-field clearfix">
                                                    Currency Unit
...
<?php /* <link rel="stylesheet" href="http://jcrop-cdn.tapmodo.com/v0.9.12/css/jquery.Jcrop.min.css" type="text/css" /> */ ?>
<script type="text/javascript">
