...
<head>
	...
	<link rel="shortcut icon" href="<?php echo e(asset('frontend/images/barcode-favicon.ico')); ?>">
      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="<?php echo e(url('/')); ?>">
          	<img src="<?php echo e(asset('frontend/images/logo.png')); ?>" alt="Barcode Logo">
          </a>
        </div>
        <div id="navbar" class="navbar-collapse collapse">
			<?php if( Auth::check() ): ?> 
				<ul class="nav navbar-nav">
					...
					<li class="<?php echo e(Request::is('barcode/list/*') || Request::is('barcode/add') || Request::is('barcode/view/*') || Request::is('barcode/edit/*')? 'active' : ''); ?>"><a href="<?php echo e(route('listBarCodebyUser',['id'=>Auth::user()->id ])); ?>">Products</a></li>
					<li class="<?php echo e(Request::is('pricing')? 'active' : ''); ?>"><a href="<?php echo e(route('getPricePage')); ?>">Pricing</a></li>
					<?php if( Auth::user()->id == 1 ): ?> 
					<li class="bread-li"><a href="javascript:void(0)">|</a></li>
					<li class="<?php echo e(Request::is('tracker.stats.index')? 'active' : ''); ?>"><a href="/admin/stats?page=summary&days=0">Statistics</a></li>
					<li class="<?php echo e(Request::is('getUserList')? 'active' : ''); ?>"><a href="<?php echo e(route('getUserList')); ?>">Admin</a></li>
					<?php endif; ?>
<!-- 					<li class="<?php echo e(Request::is('payment') || Request::is('paymentConfirm') || Request::is('paypal')? 'active' : ''); ?>"><a href="<?php echo e(route('getPayment')); ?>">Payment</a></li> -->
				</ul>
			<?php endif; ?>
          <ul class="nav navbar-nav navbar-right">
			<?php if( Auth::check() ): ?> 
	            <li class="dropdown"><a href="#" class="dropbtn" id="usernametxt"><?php echo e(Auth::user()->name); ?></a>
				  <div class="dropdown-content">
				    <a href="<?php echo e(route('getInfoAccount',['id'=>Auth::user()->id])); ?>">Profile</a>
				...
				<img style="width: 50px;height: 50px;" src="<?php echo e(asset('uploads/users/'.Auth::user()->avatar)); ?>" alt="<?php echo e(Auth::user()->name); ?>">
					<?php else: ?>
						<img style="width: 50px;height: 50px;" src="<?php echo e(asset('frontend/images/avartar_default.png')); ?>" alt="Avatar">
					<?php endif; ?>
	            </li>

			<?php else: ?>
				<li class="default <?php echo e(Request::is('add-barcode')? 'active' : ''); ?>"><a href="<?php echo e(route('getAddBarcodePage')); ?>">Add barcode</a></li>
		        <li class="default <?php echo e(Request::is('pricing')? 'active' : ''); ?>"><a href="<?php echo e(route('getPricePage')); ?>">Pricing</a></li>
		    		...
		    		<div class="item clearfix">
			    		...
			    		<div class="col-sm-offset-2 col-sm-8">
						    <form>
							    ...
							    By creating an account you agree to our <a class="terms" href="<?php echo e(url('terms-and-conditions')); ?>" target="_blank"><?php echo e($terms->title); ?></a>.

							    <div class="ajax_response alert-success" style="display: none"></div>
						    	<div id="pre_ajax_loading_register" style="display: none;text-align: center; margin-bottom: 20px;"><img src="<?php echo e(asset('images/general/bx_loader.gif')); ?>" alt="Loading"></div>
	    ...
	    <div class="modal-content">
	    	<div class="cotainer">
		    	<div class="row">
		    		<div class="item clearfix">
			    		<div class="col-sm-12">
			    			<h3><img src="<?php echo e(asset('frontend/images/icon_login.png')); ?> " alt="Icon Login"> Change password</h3>
			    		</div>
			    		...
			    		<div class="col-sm-offset-2 col-sm-8">
						    <form>
							    ...
							    <div class="ajax_response alert-success" style="display: none"></div>
						    	<div id="pre_ajax_loading_changepass" style="display: none;text-align: center; margin-bottom: 20px;"><img src="<?php echo e(asset('images/general/bx_loader.gif')); ?>" alt="Loading"></div>
							    <div class="button text-center">
	    ...
	    <div class="modal-content">
	    	<div class="cotainer">
		    	<div class="row">
		    		<div class="item clearfix">
			    		<div class="col-sm-12">
			    			<h3><img src="<?php echo e(asset('frontend/images/icon_login.png')); ?> " alt="Icon Login"> Login</h3>
			    		</div>
			    		...
			    		<div class="col-sm-offset-2 col-sm-8">
						    <form>
								...
								<div id="pre_ajax_loading" style="text-align: center; margin-bottom: 20px;display: none;"><img src="<?php echo e(asset('images/general/bx_loader.gif')); ?>" alt="Loading"></div>
	    ...
	    <div class="modal-content">
	    	<div class="cotainer">
		    	<div class="row">
		    		<div class="item clearfix">
			    		<div class="col-sm-12">
			    			<h3><img src="<?php echo e(asset('frontend/images/icon_login.png')); ?> " alt="Icon Login"> Forgot Password</h3>
			    		</div>
			    		...
			    		<div class="col-sm-offset-2 col-sm-8">
						    <form class="r_email">
						    	...
						    	<div id="pre_ajax_loading_resetcode" style="display: none;text-align: center; margin-bottom: 20px;"><img src="<?php echo e(asset('images/general/bx_loader.gif')); ?>" alt="Loading"></div>
				...
				<div class="row">
					<div class="pull-left">
				  		<ul>
				  			...
				  			?>
				  			<?php foreach($footerDatas as $footerData): ?> 
								<?php if($footerData->slug != "contact-us"): ?>
									<li>
										<a href="<?php echo url('page/' . $footerData->slug); ?>"><?php echo e($footerData->title); ?></a>
									</li>
								<?php endif; ?>
				  			<?php endforeach; ?>
							<li>
								<a href="<?php echo url('contact'); ?>"><?php echo e($contactUsData->title); ?></a>
							</li>
						</ul>
					</div>
	...
	<script src="<?php echo e(asset('frontend/js/function.js')); ?>"></script>
	<script>
