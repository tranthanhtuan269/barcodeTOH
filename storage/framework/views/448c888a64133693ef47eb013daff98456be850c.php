...
<?php $__env->startSection('title', 'Information for millions of products globally - Barcode Live'); ?>
...
<div class="container">
	<div class="row">
		...
		At Barcode Live, just by typing in the item's barcode number, you can find information for millions of products on the world: photos, name, model, manufacturer and product reviews. With huge database of barcodes and product data as well as from retailers and e-commerce sites, we will bring you the most useful and clearest info on any product you're interested in.
					...
					<div class="col-sm-4">
						<img src="<?php echo e(asset('frontend/images/product_search.jpg')); ?>" alt="Search Infomation Of Any Products">
					</div>
				</div>
			</div>
		</div>
<!-- 		<div class="box_3">
		...
		A product's packaging may not tell you everything you need to know about that product — where it comes from, how well it works, or how it's priced at other stores. Enter a barcode from any product into Barcode Lookup, and you'll find all kinds of information about the item — including its manufacturer, name, and description, as well as photos of the product and customer reviews. We'll even show you links to online stores where you can buy the same item — often for less than your local retail store is charging. We're here to make it as easy as possible for you to find what you're looking for, so you can make the right decision about which product to buy.
						...
						<div class="col-sm-offset-1 col-sm-3">
							<img class="special" src="<?php echo e(asset('frontend/images/box_3_ma_vach.png')); ?> ">
						</div>
					</div>

					<div class="item_childern_1 clearfix">
						<div class="col-sm-12">
							<img src="<?php echo e(asset('frontend/images/box_4.png')); ?> ">
							<h3>Where do we get our barcode information?</h3>
						</div>
					</div>
					<div class="item_childern_2 clearfix">
						<div class="col-sm-4">
							<img src="<?php echo e(asset('frontend/images/item_1.png')); ?> ">
						</div>
						<div class="col-sm-8">
				...
				<div class="row">
					<div class="item_left">
						<div class="item clearfix">
							<div class="col-sm-4">
								<img src="<?php echo e(asset('frontend/images/upc.jpg')); ?>" alt="Universal Product Codes">
							</div>
							<div class="col-sm-8">
						...
						<div class="item clearfix">
							<div class="col-sm-4">
								<img src="<?php echo e(asset('frontend/images/ean.jpg')); ?>" alt="International (European) Article Number">
							</div>
							<div class="col-sm-8">
						...
						<div class="item clearfix">
							<div class="col-sm-4">
								<img src="<?php echo e(asset('frontend/images/ispn.jpg')); ?>" alt="International Standard Book Number">
							</div>
							<div class="col-sm-8">
		...
		<div class="row">
				<div class="col-sm-8">
					<div class="item_left clearfix">
						...
						<div class="item_childern_2 clearfix">
							<a href="https://itunes.apple.com/us/app/qr-code-reader-barcode-scanner-qr-barcode/id1209404877?mt=8"><img src="<?php echo e(asset('frontend/images/app_store.png')); ?>" alt="Available on the App Store"></a>
							<a href="https://play.google.com/store/apps/details?id=com.tohsoft.qrcode"><img src="<?php echo e(asset('frontend/images/google_play.png')); ?>" alt="Android App on Google play"></a>
						</div>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="item_right">
						<img src="<?php echo e(asset('frontend/images/item_3.png')); ?>" alt="Mobile Scan QR code">
					</div>
				</div>
...
<div class="box_social_network">
	<div class="container">
		<div class="row text-center">
			...
			<div class="col-sm-3">
				<a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo e(url('/')); ?>" target="_blank" class="image"><img src="<?php echo e(asset('frontend/images/facebook.png')); ?>" alt="Facebook Share"></a>
			</div>
			<div class="col-sm-3">
				<a href="http://twitter.com/share?text=BarcodeLive&url=<?php echo e(url('/')); ?>" class="image"><img src="<?php echo e(asset('frontend/images/twitter.png')); ?>" alt="Twitter Share"></a>
			</div>
			<div class="col-sm-3">
				<a href="https://plus.google.com/share?url=<?php echo e(url('/')); ?>" class="image"><img src="<?php echo e(asset('frontend/images/google_plus.png')); ?>" alt="Google Plus Share"></a>
			</div>
			<div class="col-sm-3">
				<a href="mailto:?subject=I wanted you to see this site&amp;body=Check out this site http://barcodelive.org/" class="image"><img src="<?php echo e(asset('frontend/images/mail.png')); ?>" alt="Send Email"></a>
			</div>
		</div>
	</div>
</div>
